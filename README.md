...
By default, Fether will launch its embedded Parity Ethereum light client. You can also separately launch your Ethereum client (e.g on a [testnet](https://wiki.parity.io/Fether-FAQ#how-to-launch-fether-on-a-different-network)), Fether will automatically connect to it.
